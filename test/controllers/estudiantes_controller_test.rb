...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference("Estudiante.count") do
      post estudiantes_url, params: { estudiante: { curso: @estudiante.curso, nombre: @estudiante.nombre, taller_id: @estudiante.taller_id } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { curso: @estudiante.curso, nombre: @estudiante.nombre, taller_id: @estudiante.taller_id } }
